...
Song convertTextToSong(String text, String key,
    {String title = 'Untitled', List<String> authors = const []}) {
...
List<Chord> extractChords(String chordLine, String lyricLine) {
  ...
  for (final match in chordMatches) {
    ...
    //print('chordText: $chordText, chordPosition: $chordPosition');
    // Determine where in the lyric line this chord should appear
    //int lyricPosition =
    //    findChordPositionInLyrics(chordPosition, lyricLine, chordLine);
    //
    // Add chord (convert to Nashville if needed)
    chords.add(Chord(
      position: chordPosition,
      value:
          chordText, // You may want to convert this to Nashville notation here
    ));
  }
...
SongHeader extractHeaderInfo(String text,
    {String defaultTitle = 'Untitled', String defaultKey = 'C'}) {
